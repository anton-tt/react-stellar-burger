...
const INGREDIENTS_ROUT = "/ingredients/";
const INGREDIENT_PAGE = `${INGREDIENTS_ROUT}:id`;
...
export { urlBase, GET_INGREDIENTS, GET_INGREDIENTS_SUCCESS, GET_INGREDIENTS_FAILED, ADD_INGREDIENT_DETAILS, REMOVE_INGREDIENT_DETAILS, 
    ...
    PROFILE_PAGE, ORDER_FEED_PAGE, ORDER_HISTORY_PAGE, NOT_FOUND_PAGE, INGREDIENTS_ROUT, INGREDIENT_PAGE, ACCESS_TOKEN, REFRESH_TOKEN, 
    REGISTER_USER, REGISTER_USER_SUCCESS, REGISTER_USER_FAILED, REGISTER_USER_RESET_DATA, LOGIN_USER, LOGIN_USER_SUCCESS, 
    LOGIN_USER_FAILED, LOGIN_USER_RESET_DATA, LOGOUT_USER, LOGOUT_USER_SUCCESS, LOGOUT_USER_FAILED, LOGOUT_USER_RESET_DATA, 
    FORGOT_PASSWORD, FORGOT_PASSWORD_SUCCESS, FORGOT_PASSWORD_FAILED, FORGOT_MESSAGE_SUCCESS, FORGOT_PASSWORD_RESET_DATA, 
    RESET_PASSWORD, RESET_PASSWORD_SUCCESS, RESET_PASSWORD_FAILED, RESET_MESSAGE_SUCCESS, RESET_PASSWORD_RESET_DATA, GET_USER, 
    GET_USER_SUCCESS, GET_USER_FAILED, GET_USER_RESET_DATA, UPDATE_USER, UPDATE_USER_SUCCESS, UPDATE_USER_FAILED, 
    UPDATE_USER_RESET_DATA };