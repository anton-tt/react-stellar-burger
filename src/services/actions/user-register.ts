...
import { TRequestRegisterUserData, TResponseRegisterUserData, IRegisterUserAction, IRegisterUserSuccessAction, IRegisterUserFailedAction, 
...
const registerUserSuccess = (success: boolean, user:  TResponseRegisterUserData): IRegisterUserSuccessAction => ({
...
export function registerUser(userData: TRequestRegisterUserData) {
